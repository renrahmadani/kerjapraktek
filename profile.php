...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'customer') {
    ...
    <body style='background:#f8fafc;'><script>
        Swal.fire({
            icon: 'warning',
            title: 'Akses Ditolak',
            text: 'Silakan login sebagai Pelanggan untuk melihat profil.',
...
<body style="background: var(--background);">
    ...
    <main class="profile-wrapper">
        ...
        <style>
            .booking-row-item { transition: background-color 0.2s ease; }
            .booking-row-item:hover { background-color: #f1f5f9 !important; }
            .booking-note-alert { background-color: #eff6ff; color: #1e3a8a; padding: 12px 16px; border-radius: 8px; border-left: 4px solid #3b82f6; font-size: 0.9rem; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 8px; }
        </style>
        <div class="history-card">
            ...
            <?php else: ?>
                <div class="booking-note-alert">
                    <span>💡 Klik pada baris pesanan untuk melihat detail histori dan jejak waktu proses servis.</span>
                </div>
