        ...
        <div class="container hero-content">
            ...
            <div class="hero-text">
                ...
                <div class="hero-buttons">
                    ...
                    <button class="btn-large outline" style="border-color: #22c55e; color: #22c55e;" onmouseover="this.style.backgroundColor='#f0fdf4';" onmouseout="this.style.backgroundColor='transparent';" onclick="window.open('https://wa.me/<?= WA_NUMBER ?>?text=Halo%20Bengkel%20Wahana%20Indo%20Trada', '_blank')">
                        Hubungi Kami
                    </button>
                </div>
            </div>
